        ...
        <div className="card card-body bg-secondary text-light animate__animated animate__fadeIn">
          <div className="row">
            <div className="col-md-4 text-center">
              <img src="/portada.jpg" alt="" className="img-fluid" />
            </div>
            <div className="col-md-8">
              <h1>William Alape Rivera</h1>
              ...
              <Link href="https://generacionxbox.com/wp-content/uploads/2018/02/goku-ultra-generacion-xbox.jpg" className="btn btn-outline-light">
                Hire Me
              </Link>
            </div>
          </div>
      ...
      <div className="col-md-8 py-2">
        ...
        <div className="card bg-light animate__animated animate__fadeInRight">
          <div className="card-body">
            ...
            <Link href="https://mir-s3-cdn-cf.behance.net/projects/404/7a9c29115867713.Y3JvcCw5NjAsNzUwLDAsMTA0.jpg" className="btn btn-light">
              Know More
            </Link>
          </div>
        </div>
